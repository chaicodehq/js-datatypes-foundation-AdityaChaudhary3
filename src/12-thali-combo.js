...
export function createThaliDescription(thali) {
  ...
  // if(typeof(thali) !== 'object' || !thali.hasOwnProperty('name') || !thali.hasOwnProperty('items') || !thali.hasOwnProperty('price')  || !thali.hasOwnProperty('isVeg') ) return "";
...
export function generateThaliReceipt(customerName, thalis) {
  // Your code here
     ...
     if (
        typeof customerName !== "string" || !Array.isArray(thalis) || thalis.length === 0)    return "";
